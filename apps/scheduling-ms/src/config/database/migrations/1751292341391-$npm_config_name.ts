...
export class  $npmConfigName1751292341391 implements MigrationInterface {
    name = ' $npmConfigName1751292341391'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."appointments_service_type_enum" AS ENUM('REPAIR', 'MAINTENANCE')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_090ed91a83a3e7a0578ac21dee" ON "appointments" ("id", "cellphone") `);
        await queryRunner.query(`CREATE INDEX "IDX_a951dbc086a64157edd85537e9" ON "appointments" ("date", "service_type") `);
        await queryRunner.query(`CREATE INDEX "IDX_9a53f1fe7e71e2099b948a0ea6" ON "appointments" ("cellphone") `);
    }
